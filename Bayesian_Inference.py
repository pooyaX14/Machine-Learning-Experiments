...
# frequency_matrix = pd.DataFrame(data=doc_array[0:,0:], columns=count_vector.get_feature_names())
...
Calculating the probabilities of Jill giving speech which includes words 'freedom' and 'immigration'
...
Calculating the probabilities of Gary giving speech which includes words 'freedom' and 'immigration'
